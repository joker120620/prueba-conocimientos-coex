...
?>
        ...
        <section class="modal_oculto" id="modal">
          ...
          <div class="con_sec_reg">
              ...
              <form class="div_registro" action="" method="post">
                <div class="con_for_1">
                  <div class="cont_input">
                    <label for="" >Nombre</label>
                  <input class="input_form_reg" type="text" name="nombreClie" placeholder="Nombre">
                  </div>
                  <div class="cont_input">
                    <label for="" >Apellido</label>
                  <input class="input_form_reg" type="text" name="apellidoClie" placeholder="Apellido"></div>
                  <div class="cont_input">
                    <label for="" >Nit/CC</label>
                  <input class="input_form_reg" type="text" name="nitClie" placeholder="NIT/CC">
                  </div>
                  <div class="cont_input">
                    <label for="" >Dirección</label>
                  <input class="input_form_reg" type="text" name="direccionClie" placeholder="Dirección">
                  </div>
                  <div class="cont_input">
                    <label for="" >Ciudad</label>
                  <input class="input_form_reg" type="text" name="ciudadClie" placeholder="Ciudad">
                  </div>
                  <div class="cont_input">
                    <label for="" >Telefono</label>
                  <input class="input_form_reg" type="tel" name="telefonoClie" placeholder="Telefono">
                  </div>
                  <div class="cont_input">
                    <label for="" >Contacto</label>
                  <input class="input_form_reg" type="text" name="contactoClie" placeholder="Contacto">
                  </div>
                ...
                <div class="con_for_2">
                  ...
                  <input class="input_form_reg" type="text" name="cupoClie"placeholder="Cupo">
                  </div>
                  <div class="cont_input">
                    <label for="" >
                    Cupo disponible</label>
                  <input class="input_form_reg" type="text" name="cupoDClie" placeholder="Cupo Disponible ">
                  </div>
                  <div class="cont_input">
                    <label for="" >Dia de gracia</label>
                  <input class="input_form_reg" type="text" name="diaDClie" placeholder="Dia de gracia">
                  </div>
                </div>
